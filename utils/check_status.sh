...
CONTAINER=$(docker ps --filter "name=qwen3-a3b" --filter "name=qwen3-32b" --filter "name=phi4-reasoning" --filter "name=llama33-70b" --filter "name=deepseek-v32" --filter "name=nemotron-120b" --filter "name=kimi-k25" --format "{{.Names}}" | head -1)
