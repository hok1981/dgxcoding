...
| nemotron-120b | nvidia/NVIDIA-Nemotron-3-Super-120B-A12B-NVFP4 | 8007 | nemotron120b | 12B | **Does not fit** — NVFP4 scale tensors push actual footprint to ~110 GiB, OOM on 119.7 GiB |
...
| qwen25-vl | Qwen/Qwen2.5-VL-7B-Instruct (vLLM) | 8011 | qwen25vl | 7B | Vision+text, camera analysis — uses vLLM (TRT-LLM 1.3.0rc7 has multimodal bug) |
